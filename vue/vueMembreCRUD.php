<section class="container py-5">
    <div class="row">
        <div class="col-lg-8 col-sm mb-5 mx-auto">
            <h1 class="fs-4 text-center lead text-primary">CRUD Membre</h1>
        </div>
    </div>
    <div class="dropdown-divider border-warning"></div>
    <div class="row">
        <div class="col-md-6">
            <h5 class="fw-bold mb-0">Les Membres</h5>
        </div>
        <div class="col-md-6">
            <div class="d-flex justify-content-end">
                <button class="btn btn-primary btn-sm me-3 " data-bs-toggle="modal" data-bs-target="#createModal">
                    <i class="fas fa-folder-plus"></i> Nouveau Membre
                </button>
    ...
    <div class="row">
        <div class="table-responsive" id="responsableTable">
            <h3 class="text-success text-center">Chargement des membres</h3>
        </div>
    </div>
</section>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createModalLabel">Nouveau Membre</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" name="ajouterResponsable" id="ajouterResponsable">Ajouter un membre <i class="fas fa-plus"></i></button>
            </div>
        </div>
    </div>
</div>